...
class TestNewContact(TestBase):
    ...
    def test_new(self):
        ...
        print(Contact.query.filter_by(Contact.first_name=contact.first_name).first())
        assert Contact.query.filter_by(Contact.first_name=contact.first_name).first() == contact.first_name
